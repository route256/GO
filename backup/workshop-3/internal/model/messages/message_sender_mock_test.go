...
//go:generate minimock -i gitlab.ozon.dev/go/classroom-4/teachers/homework/internal/model/messages.MessageSender -o ./message_sender_mock_test.go -n MessageSenderMock
...
type MessageSenderMock struct {
	...
	funcSendMessage          func(text string, userID int64, buttons ...map[string]string) (err error)
	inspectFuncSendMessage   func(text string, userID int64, buttons ...map[string]string)
...
func (mmSendMessage *mMessageSenderMockSendMessage) Expect(text string, userID int64, buttons ...map[string]string) *mMessageSenderMockSendMessage {
	...
	mmSendMessage.defaultExpectation.params = &MessageSenderMockSendMessageParams{text, userID, buttons}
...
func (mmSendMessage *mMessageSenderMockSendMessage) Inspect(f func(text string, userID int64, buttons ...map[string]string)) *mMessageSenderMockSendMessage {
...
func (mmSendMessage *mMessageSenderMockSendMessage) Set(f func(text string, userID int64, buttons ...map[string]string) (err error)) *MessageSenderMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mMessageSenderMockSendMessage) When(text string, userID int64, buttons ...map[string]string) *MessageSenderMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("MessageSenderMock.SendMessage mock is already set by Set")
	}
	...
	expectation := &MessageSenderMockSendMessageExpectation{
		...
		params: &MessageSenderMockSendMessageParams{text, userID, buttons},
	}
...
func (mmSendMessage *MessageSenderMock) SendMessage(text string, userID int64, buttons ...map[string]string) (err error) {
	mm_atomic.AddUint64(&mmSendMessage.beforeSendMessageCounter, 1)
	defer mm_atomic.AddUint64(&mmSendMessage.afterSendMessageCounter, 1)

	if mmSendMessage.inspectFuncSendMessage != nil {
		mmSendMessage.inspectFuncSendMessage(text, userID, buttons...)
	}

	mm_params := &MessageSenderMockSendMessageParams{text, userID, buttons}
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		mm_got := MessageSenderMockSendMessageParams{text, userID, buttons}
	...
	if mmSendMessage.funcSendMessage != nil {
		return mmSendMessage.funcSendMessage(text, userID, buttons...)
	}
	mmSendMessage.t.Fatalf("Unexpected call to MessageSenderMock.SendMessage. %v %v %v", text, userID, buttons)
	return
}
